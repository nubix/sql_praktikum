...
\section{Zusammenführung und Restrukturierung}
  Der Übersichtlichkeit halber wurde das Diagramm in die beiden Pakete \textsc{netflax} und \textsc{first.fm} eingeteilt. Die Überschneidungen kennzeichnen sich durch die selben Klassennahmen.
  
  \subsection{Paket \textsc{first.fm}}
    \includegraphics[angle=90,trim=0cm 0cm 1.1cm 1cm, clip=true, scale=1]{Diagramme/Paket_FirstFm}
